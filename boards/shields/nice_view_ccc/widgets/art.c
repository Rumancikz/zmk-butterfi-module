...
#ifndef LV_ATTRIBUTE_IMG_CCC
#define LV_ATTRIBUTE_IMG_CCC
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_CCC uint8_t CCC_map[] = {
